...
void loadConfigs(){
	char* CONFIG_PATH = "./properties/masterClient.properties";
	config = config_create(CONFIG_PATH);
	if(!(config_has_property(config,"WORKER_IP"))|| !(config_has_property(config,"WORKER_PUERTO"))){
...
void createLoggers(){
	char* LOG_PATH = "./logs/masterClient.log";
